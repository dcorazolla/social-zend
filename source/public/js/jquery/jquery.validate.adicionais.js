// métodos adicionais para o jquery validate


// valida CPF
jQuery.validator.addMethod("cpf", function(value, element) {
    if (value=="___.___.___-__" || value=="") return true;
    value = value.replace('.','');
    value = value.replace('.','');
    cpf = value.replace('-','');
...
// validando data e hora dd/mm/yyyy hh:ii:ss
...
// valida CNPJ com 14 ou 15 dígitos
