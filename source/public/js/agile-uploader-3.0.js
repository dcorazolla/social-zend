(function($) {
	...
	*/
	$.fn.agileUploaderServerResponse = function(response) {
		...
		$("#agileUploaderInfo").hide();
		$("#botao_enviar_fotos").hide();
		
		$("#container-resposta-upload-fotos-perfil").html(response);
	...
	*/
	$.fn.agileUploaderAttachFile = function(file) {
		...
		$("#agileUploaderInfo").show();
		$("#botao_enviar_fotos").show();
		...
		$('#agileUploaderFileList').append('<li id="id-'+file.uid+'" class="'+alt+'"><div class="agileUploaderFilePreview" style="display: none;"></div><div class="agileUploaderFileName" style="display: none;">'+((file.fileName.length>30)?(file.fileName.substr(0,23)+"..."+file.fileName.substr(file.fileName.lastIndexOf('.'), 4)):file.fileName)+'</div><div id="'+file.uid+'CurrentProgress" class="agileUploaderCurrentProgress"></div><div class="agileUploaderFileSize" style="display: none;"></div><div class="agileUploaderRemoveFile" style="display:none;"><a href="#" id="remove-'+file.uid+'" onClick="document.getElementById(\'agileUploaderSWF\').removeFile(\''+file.uid+'\'); return false;"><img class="agileUploaderRemoveIcon" src="'+opts.removeIcon+'" alt="Remover foto da fila" /></a></div></li>');
	...
	*/
	$.fn.agileUploader = function(options) {			
		...
		return this.each(function() {
			...
			$('#'+this.id).prepend('<div id="agileUploaderRemoveAll" style="display:none;"></div><div id="agileUploaderInfo" style="display:none;"><ul id="agileUploaderFileList"></ul></div>');
		});	
	}
	...
	*/
	...
	$.fn.agileUploader.defaults = {
		...
		flashSrc: '/images/agile-uploader.swf',
		flashWidth: 25,
		flashHeight: 22,
		...
		flashVars: {
			...
			file_limit: -1,
			button_up:'/images/add-file.png',
			button_over:'/images/add-file.png',
			button_down:'/images/add-file.png'		
		},
		progressBarColor: '#ff0000',
		attachScrollSpeed: 1000,		
		removeIcon: '/images/trash-icon.png',
		genericFileIcon: '/images/file-icon.png',
		maxPostSizeMessage: 'Arquivos muito grandes.',
		maxFileMessage: 'Limite de arquivos atingido. Remova um antes de prosseguir.',
